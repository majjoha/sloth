...
void print_instruction(int* instructions, int* pi) {
  switch (instructions[*pi]) {
    case PUSHGLOBAL: {
      printf("PUSHGLOBAL %d; ", instructions[++(*pi)]);
      break;
    }
    case PUSH: {
      printf("PUSH %d; ", instructions[++(*pi)]);
      break;
    }
    case PUSHINT: {
      printf("PUSHINT %d; ", instructions[++(*pi)]);
      break;
    }
    case MKAP: {
      printf("MKAP; ");
    ...
    case SLIDE: {
      printf("SLIDE %d; ", instructions[++(*pi)]);
      break;
    }
    case JUMP: {
      printf("JUMP %d; ", instructions[++(*pi)]);
      break;
    }
    case UPDATE: {
      printf("UPDATE %d; ", instructions[++(*pi)]);
      break;
    }
    case POP: {
      printf("POP %d; ", instructions[++(*pi)]);
      break;
    }
    case ALLOC: {
      printf("ALLOC %d; ", instructions[++(*pi)]);
      break;
    }
    case EVAL: {
      printf("EVAL; ");
    ...
    case JFALSE: {
      printf("JFALSE %d;", instructions[++(*pi)]);
      break;
    }
    case LABEL: {
      printf("LABEL; ");
    ...
    case PACK: {
      printf("PACK %d %d;", instructions[++(*pi)], instructions[++(*pi)]);
      break;
    }
    case SPLIT: {
      printf("SPLIT %d;", instructions[++(*pi)]);
      break;
    }
    case CASEJUMP: {
      printf("CASEJUMP;");
